...
export const EYE_GAMES: EyeActivity[] = [
  {
    id: 'saccade-sniper',
    title: 'Target Tap',
    subtitle: 'Tap the moving targets',
    durationSeconds: 60,
    description: 'Tap glowing targets in a short visual-coordination game. Game scores are not a measure of eye health.',
    kind: 'game',
    emoji: '🎯',
    isPremium: false,
  },
  {
    id: 'focus-sprint',
    title: 'Focus Switch',
    subtitle: 'Switch near and far focus',
    durationSeconds: 90,
  ...
  },
  {
    ...
    subtitle: 'See in 3D',
    durationSeconds: 60,
    description: 'A color-based coordination game for red/cyan glasses. Not a substitute for clinician-prescribed vision therapy.',
    kind: 'game',
    emoji: '🥽',
    isPremium: false,
...
export const COMET_TRACE_ACTIVITY: EyeActivity = {
  ...
  durationSeconds: 60,
  description: 'Hold your finger on the moving comet and follow it comfortably. Stop if the motion causes discomfort or dizziness.',
  kind: 'exercise',
  emoji: '☄️',
  isPremium: false,
};
