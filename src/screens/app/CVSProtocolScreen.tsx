...
const styles = StyleSheet.create({
  ...
  stepList: { alignSelf: 'stretch', backgroundColor: C.card, borderRadius: 16, paddingVertical: 12, paddingHorizontal: 14, gap: 12, borderWidth: 1, borderColor: 'rgba(255,255,255,0.05)' },
  ...
  completionRow: { flexDirection: 'row', alignSelf: 'stretch', backgroundColor: C.card, borderRadius: 16, paddingVertical: 18, paddingHorizontal: 18, alignItems: 'center', justifyContent: 'space-around', borderWidth: 1, borderColor: 'rgba(255,255,255,0.05)' },
  ...
  confirmCard: { width: '100%', maxWidth: 360, backgroundColor: '#0F1228', borderRadius: 18, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)', padding: 20, gap: 10 },
